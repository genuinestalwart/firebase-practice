    ...
    return (
        <div className='flex justify-center py-8'>
            <div className='bg-slate-100 border-4 border-slate-200 divide-y rounded-lg w-2/5'>
                <h1 className='font-medium my-2 text-center text-2xl text-indigo-400'>Sign Up</h1>
                ...
                <div className='py-2'>
                    <div className='px-4'>
                        ...
                        <div className='text-right'><button onClick={validate} className='bg-indigo-400 hover:bg-indigo-500 my-2 px-4 py-2 active:ring ring-indigo-400 ring-offset-2 rounded-md text-white'>Sign up</button></div>
                    </div>
                </div>
            </div>
        </div>
